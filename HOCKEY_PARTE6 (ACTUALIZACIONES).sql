...
update equipos
set tfnConta = '777666555'
where numReg in (select numger from equipos where nombre like '%Gijón%')
...
update jugadoras
set numreg = 16
where numfed in (select numfed from jugadoras where nombre like '%Moisés%' and ape1 like '%Aguirre%' and ape2 like '%Vega%')
