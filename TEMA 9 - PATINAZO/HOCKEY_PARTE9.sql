...
--VALUES (30, 'Hockey Club Coruña', 'A Coruña', '2023-04-15', NULL, NULL, 's', 'GAL', 99)
...
--create view vw_Numequipos as
--select ca.nombre, ca.ccaa, count(e.numReg) [nº Equipos] from Equipos e
...
--select e.nombre [NombreEquipo], j.numFed, j.nombre NombreJugadora, j.ape1, j.ape2, count(*) [Nº Goles] from golear gol
...
--go
--create view vw as
--select e.numReg, e.nombre, count(j.numFed) [Nº Jugadoras] from equipos e
